...
{
	ConstantBuffer<PhongProperty> constantBuffer;

public:
	PhongProperty property;

	PhongPass() :
		constantBuffer(RenderPipeline::instance->device_, RenderPipeline::instance->commandList_),
		property({ {0.3,0.3,0,0},{ 0,0,0,0 } })
	{
		shaderPath = L"Src/Shaders/PhongShaders.hlsl";
	...
	void SetBuffer() override
	{
		...
		constantBuffer.SetConstantBufferView(2);
	} 
};
